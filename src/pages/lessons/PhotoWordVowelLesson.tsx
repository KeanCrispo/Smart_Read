...
export default function PhotoWordVowelLesson() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex items-center justify-center gap-4 pt-10 mb-8" style={{maxWidth: 1200}}>
        <div className="flex-1 flex justify-start">
          <Link
            to="/lessons/vowel"
            className="bg-yellow-400 hover:bg-yellow-300 text-blue-800 font-bold py-3 px-8 rounded-full shadow-lg text-xl transition-colors duration-200 border-2 border-yellow-200 flex items-center gap-2"
            style={{
              boxShadow: '0 2px 8px rgba(0,0,0,0.10)',
              letterSpacing: 1,
            }}
          >
            <span className="text-2xl">⬅️</span> Back to Vowel Select
          </Link>
        </div>
        <div className="flex-1 flex justify-center">
          <h1
            className="text-5xl font-extrabold text-blue-700 text-center"
            style={{
      ...
      >
        ...
        >
          <img
            ...
            style={{
              ...
              left: '50%',
              top: '50%',
              width: 900, // Make the photo very big for all words
              height: 900,
        ...
        {/* Word */}
        <div className="text-4xl font-extrabold text-[#a94442] mb-8 capitalize font-[Comic Sans MS,cursive,sans-serif] tracking-wide text-center">
          {word}
        </div>
        {/* Navigation and action buttons */}
        <div className="flex flex-wrap justify-center gap-4 mb-4 w-full">
          <button
            className="bg-blue-200 hover:bg-blue-300 text-blue-800 px-8 py-3 rounded-full font-bold text-lg shadow transition-all duration-200 disabled:opacity-50"
          ...
          <button
            className="bg-blue-400 hover:bg-blue-500 text-white px-8 py-3 rounded-full font-bold text-lg shadow transition-all duration-200 disabled:opacity-50"
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-2 w-full">
          <button
            className="bg-pink-200 hover:bg-pink-300 text-[#a94442] px-8 py-3 rounded-full font-bold text-lg shadow transition-all duration-200"
            onClick={handleUseInSentence}
          >
            🔊 Use in a sentence
          </button>
          <button
            className="bg-yellow-300 hover:bg-yellow-400 text-[#6d4c00] px-8 py-3 rounded-full font-bold text-lg shadow transition-all duration-200"
        ...
        {index === words.length - 1 && (
          <Link
            ...
            className="mt-4 bg-green-400 hover:bg-green-500 text-white px-10 py-4 rounded-full font-bold text-xl shadow-lg transition-all duration-200"
          >
            🎉 Take Quiz!
          </Link>
        )}
      </div>
      <div className="mt-8 text-lg text-blue-600 font-semibold z-10">
      ...
      {showSentence && (
        ...
        >
          ...
          >
            {sentence}
            <div style={{fontSize: '1rem', color: '#888', marginTop: 16}}>(Click anywhere to close)</div>
          </div>
        </div>
      )}
    </div>
