  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {!chatOpen ? (
        <div
          className="fixed"
          style={{ bottom: '6rem', right: '2rem', zIndex: 50 }} // Move up and keep right
        >
          <button
          ...
          >
            ...
            <img
              src={textBubble}
              alt="Chat Bubble"
              className="absolute right-[110px] bottom-[65%] translate-y-1/2 transition-opacity duration-200 opacity-0 group-hover:opacity-100 pointer-events-none"
              style={{ width: 55, height: 'auto' }} // Slightly bigger bubble
            />
            <img
              src={aiIcon}
              alt="AI Chat"
              style={{ width: 110, height: 110, objectFit: 'contain', display: 'block', filter: 'drop-shadow(0 0 12px #60a5fa)' }} // Slightly bigger icon
            />
